...
#include "RemoteDriver.hh"

// This "remote support" code is not part of the remote plugin library, but supports the ACI to
// allow "clients" to test/probe/configure/control the client side of remote containers,
// whether or not the plugin is loaded.  The actual API is defined in OcpiContainerApi.hh
