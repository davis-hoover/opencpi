...
// This file implements a discoverable server, which "serves up" sessions for clients.
// What service is being provided is determined by the derived class for this server class,
// by implementing the abstract addClient method.
namespace OCPI {
  namespace Remote {
    class Client;
    class Server {
      ...
      // These are TCP clients that are using us as a server
    ...
    protected:
      ...
      // This is the key method that the derived class must implement.
