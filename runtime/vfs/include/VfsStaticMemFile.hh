...
namespace OCPI {
  namespace VFS {
    namespace MemFs {
       ...
       * OCPI::VFS::MemFs::MemFileChunk elements, i.e., the end of
       ...
       * system of type OCPI::VFS::MemFs::StaticMemFs to be accessible
