  ...
  case std::ios_base::end:
    {
      ...
      // First make it the right size, then make it the right signedness
      origin = static_cast<pos_type>(static_cast<std::streamsize>(fileInfo.uncompressed_size));
