...
namespace OCPI {
  ...
  namespace Msg {
    ...
    public:
      ...
      MessageCircuit(OCPI::Transport::Transport &transport,
		     //		     OCPI::OS::Mutex &mutex,
                     OCPI::Transport::Circuit &send,
                     OCPI::Transport::Circuit &rcv);
       ...
       *  Send a message
       **********************************/
      OCPI::Transport::BufferUserFacet*
	getNextEmptyOutputBuffer(uint8_t *&data, size_t &length, OCPI::OS::Timer *timer = NULL);
      void sendOutputBuffer( OCPI::Transport::BufferUserFacet* msg, size_t length, uint8_t opcode);
	...
	getNextFullInputBuffer(uint8_t *&data, size_t &length, uint8_t &opcode,
			       OCPI::OS::Timer *timer = NULL);
      void releaseInputBuffer( OCPI::Transport::BufferUserFacet* msg );
      void dispatch(OCPI::Xfer::EventManager* eh = NULL);


      /**********************************
       *  Get the individual circuits
       **********************************/
      // Circuit* getSendCircuit();
      // Circuit* getRcvCircuit();
    ...
    private:
      OCPI::Transport::Circuit & makeCircuit(OCPI::Xfer::EndPoint &from, OCPI::Xfer::EndPoint &to, bool send,
      ...
      OCPI::Transport::Port* m_rcv_port;
      OCPI::Transport::Port* m_send_port;
    };
  }
}
