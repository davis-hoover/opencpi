...
namespace OCPI {
  namespace Msg {
    ...
    class MessageEndpoint : private OCPI::Transport::NewCircuitRequestListener, virtual protected OCPI::Util::SelfMutex {
    public:
    ...
    private:
      ...
      inline void dispatch(OCPI::Xfer::EventManager* eh = NULL) {
	OCPI::Util::SelfAutoMutex guard (this);
	m_transport->dispatch( eh );
      }
      void newCircuitAvailable(OCPI::Transport::Circuit* circuit);

      // Set for convenient removal
      typedef std::set<MessageEndpoint *> MessageEndpoints;
      static MessageEndpoints s_messageEndpoints;
      OCPI::Transport::TransportManager &m_transportManager;
      OCPI::Transport::Transport *m_transport;             // a pointer for resource management during construction
      OCPI::Xfer::EndPoint *m_endpoint; // ditto
      ...
      typedef std::list<OCPI::Transport::Circuit *> HalfCircuits;
