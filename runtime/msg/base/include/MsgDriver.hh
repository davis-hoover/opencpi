...
namespace Msg {
	...
	Pending = 2
       ...
       */
      virtual void sendOutputBuffer(OCPI::Transport::BufferUserFacet* buffer,
				    size_t msg_size, uint8_t opcode = 0 ) = 0;

      /*
       * Release a buffer previously leased by nextMsg
       */
      virtual void releaseInputBuffer(OCPI::Transport::BufferUserFacet*  buffer) = 0;    

      /*
       * Get a free output buffer if one is available
       */
      virtual  OCPI::Transport::BufferUserFacet*
