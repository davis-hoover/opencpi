...
class AD9361FSKCSP : public AD9361CSP, public CICDecCSP, public ComplexMixerCSP, public CICIntCSP {
  /* @brief instance AD9361
   *        by defining its Constraint Satisfaction Problem (CSP) as <X,D,C>
   ****************************************************************************/
  void instance_ad9361_fsk() {
    instance_ad9361();
    instance_cic_dec();
    instance_complex_mixer();
    instance_cic_int();
  }
  void connect_ad9361_rx1_to_cic_dec() {
    m_solver.add_constr("ad9361_fc_meghz_rx1", "=", "cic_dec_fc_xin");
    m_solver.add_constr("ad9361_bw_meghz_rx1", "=", "cic_dec_bw_xin");
    m_solver.add_constr("ad9361_fs_megsps_rx1", "=", "cic_dec_fs_xin");
  }
  void connect_cic_dec_to_complex_mixer() {
    m_solver.add_constr("cic_dec_fc_xout", "=", "complex_mixer_fc_xin");
    m_solver.add_constr("cic_dec_bw_xout", "=", "complex_mixer_bw_xin");
    m_solver.add_constr("cic_dec_fs_xout", "=", "complex_mixer_fs_xin");
  }
  void connect_cic_int_to_ad9361_tx1() {
    m_solver.add_constr("cic_int_fc_xout", "=", "ad9361_fc_meghz_tx1");
    m_solver.add_constr("cic_int_bw_xout", "=", "ad9361_bw_meghz_rx1");
    m_solver.add_constr("cic_int_fs_xout", "=", "ad9361_fs_megsps_rx1");
  }
  /// @brief define Constraint Satisfaction Problem (CSP)
  void define() {
    connect_ad9361_rx1_to_cic_dec();
    connect_cic_dec_to_complex_mixer();
    connect_cic_int_to_ad9361_tx1();
  }
...
class AD9361FSKConfigurator : public AD9361Configurator, public Configurator<CICDecCSP>, public Configurator<CICIntCSP>, public Configurator<ComplexMixerCSP> {
}; // class AD9361FSKConfigurator
...
#define AD9361FSK_CONFIGURATOR AD9361FSKConfigurator
#else
#define AD9361_CONFIGURATOR Configurator<CSPBase>
#define AD9361FSK_CONFIGURATOR Configurator<CSPBase>
#endif
...
template<class log_t, class slave_cfg_t, class slave_data_sub_t, class cfgrtr_t = AD9361FSK_CONFIGURATOR>
class AD9361FSKDRC : public AD9361FSKDRC<log_t,slave_cfg_t,slave_data_sub_t,cfgrtr_t> {
} // namespace DRC
