...
#ifndef _OCPI_DRC_RADIO_CTRLR_HH
#define _OCPI_DRC_RADIO_CTRLR_HH
 ...
 ******************************************************************************/
class AnaRadioCtrlr : public OCPI::Util::LogPrefix {
protected : const char* m_descriptor;
protected : const char *get_prefix() { return m_descriptor; }
// child class is expected to have a member derived from Configurator
protected : Configurator& m_configurator;

public : std::vector<ConfigLock> m_config_locks;

protected : std::vector<data_stream_ID_t> m_data_stream_IDs;

public    : AnaRadioCtrlr(const char* descriptor, Configurator& configurator);
 ...
 ******************************************************************************/
protected : void log_info_config_lock_tol(bool did_lock, bool is,
                const data_stream_ID_t& ds_ID,
 ...
 *         queried for valid ranges before hardware actuation is performed.
 ******************************************************************************/
class DigRadioCtrlr : public AnaRadioCtrlr {
protected : std::vector<bool> m_ranges_possible_samples_are_complex;

public    : DigRadioCtrlr(const char* descriptor, Configurator& configurator);
