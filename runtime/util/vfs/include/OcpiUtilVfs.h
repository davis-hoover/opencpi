...
#ifndef OCPIUTILVFS_H__
#define OCPIUTILVFS_H__

/**
 * \file
 * \brief The OCPI::Util::Vfs::Vfs abstract base class for the file system API.
 *
 * This file defines the OCPI::Util::Vfs::Vfs abstract base class,
  ...
  namespace Util {
    ...
    namespace Vfs {
      ...
      public:
         ...
         * Equivalent to OCPI::Util::Vfs::joinNames (cwd(), name).
         *
         ...
         * Equivalent to OCPI::Util::Vfs::directoryName (absoluteName (name)).
         *
         * \param[in] name A file name.
