...
extern "C" {
  ...
  {
    OCPI::Util::Vfs::Vfs * fs = static_cast<OCPI::Util::Vfs::Vfs *> (opaque);
...
namespace {
  ...
  void
  updateZipFile (OCPI::Util::Vfs::Vfs * fs,
...
OCPI::Util::ZipFs::ZipFs::ZipFs (OCPI::Util::Vfs::Vfs * fs,
                                const std::string & zipFileName,
...
void
OCPI::Util::ZipFs::ZipFs::openZip (OCPI::Util::Vfs::Vfs * fs,
                                  const std::string & zipFileName,
                                  std::ios_base::openmode mode,
                                  bool adopt,
                                  bool keepOpen)
...
void
OCPI::Util::ZipFs::ZipFs::closeZip ()
  throw (std::string)
{
  if (!m_fs) {
...
std::string
OCPI::Util::ZipFs::ZipFs::absoluteNameLocked (const std::string & name) const
  throw (std::string)
{
...
std::string
OCPI::Util::ZipFs::ZipFs::baseURI () const
  throw ()
{
  return m_baseURI;
}
...
std::string
OCPI::Util::ZipFs::ZipFs::nameToURI (const std::string & fileName) const
  throw (std::string)
{
...
std::string
OCPI::Util::ZipFs::ZipFs::URIToName (const std::string & uri) const
  throw (std::string)
{
...
std::string
OCPI::Util::ZipFs::ZipFs::cwd () const
  throw (std::string)
{
...
void
OCPI::Util::ZipFs::ZipFs::cd (const std::string & fileName)
  throw (std::string)
{
...
void
OCPI::Util::ZipFs::ZipFs::mkdir (const std::string & fileName)
  throw (std::string)
{
  OCPI::Util::AutoRDLock lock (m_lock);
...
void
OCPI::Util::ZipFs::ZipFs::rmdir (const std::string & fileName)
  throw (std::string)
{
  OCPI::Util::AutoRDLock lock (m_lock);
...
void
OCPI::Util::ZipFs::ZipFs::closeIterator (OCPI::Util::Vfs::Iterator * it)
  throw (std::string)
{
...
bool
OCPI::Util::ZipFs::ZipFs::exists (const std::string & fileName, bool * isDir)
  throw (std::string)
{
  OCPI::Util::AutoRDLock lock (m_lock);
...
unsigned long long
OCPI::Util::ZipFs::ZipFs::size (const std::string & fileName)
  throw (std::string)
{
  OCPI::Util::AutoRDLock lock (m_lock);
...
std::time_t
OCPI::Util::ZipFs::ZipFs::lastModified (const std::string & fileName)
  throw (std::string)
{
  OCPI::Util::AutoRDLock lock (m_lock);
...
std::iostream *
OCPI::Util::ZipFs::ZipFs::open (const std::string &, std::ios_base::openmode)
  throw (std::string)
{
  /*
...
std::istream *
OCPI::Util::ZipFs::ZipFs::openReadonly (const std::string & fileName,
  ...
  throw (std::string)
{
  ...
  return new OCPI::Util::ZipFs::zipistream (zf);
}

std::ostream *
OCPI::Util::ZipFs::ZipFs::openWriteonly (const std::string & fileName,
                                        std::ios_base::openmode mode)
  throw (std::string)
{
  m_lock.wrLock ();
  ...
  return new OCPI::Util::ZipFs::zipostream (zf);
}

void
OCPI::Util::ZipFs::ZipFs::close (std::ios * str)
  throw (std::string)
{
  if (dynamic_cast<OCPI::Util::ZipFs::zipistream *> (str) == 0 &&
      dynamic_cast<OCPI::Util::ZipFs::zipostream *> (str) == 0) {
  ...
  OCPI::Util::ZipFs::zipistream * zis =
    dynamic_cast<OCPI::Util::ZipFs::zipistream *> (str);
  ...
  OCPI::Util::ZipFs::zipostream * zos =
    dynamic_cast<OCPI::Util::ZipFs::zipostream *> (str);
...
void
OCPI::Util::ZipFs::ZipFs::rename (const std::string & oldName,
...
void
OCPI::Util::ZipFs::ZipFs::remove (const std::string & fileName)
  throw (std::string)
{
  OCPI::Util::AutoWRLock lock (m_lock);
...
void
OCPI::Util::ZipFs::ZipFs::removeLocked (const std::string & fileName)
  throw (std::string)
{
  if (!(m_mode & std::ios_base::out)) {
    throw std::string ("ZIP file not open for writing");
...
std::string
OCPI::Util::ZipFs::ZipFs::nativeFilename (const std::string & name)
  throw ()
{
...
void
OCPI::Util::ZipFs::ZipFs::updateContents ()
  throw (std::string)
{
  if (m_zipFile) {
    zipFile zf = static_cast<zipFile> (m_zipFile);
