...
extern int32_t xfer_pio_create(EndPoint &, EndPoint&, PIO_template *);
extern int32_t xfer_pio_copy(PIO_template, Offset, Offset, size_t, int32_t, 
			     PIO_transfer *);
...
extern void xfer_pio_modify( PIO_transfer, int,  Offset*,  Offset* );
