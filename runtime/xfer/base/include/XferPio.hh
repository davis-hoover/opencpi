...
/* External functions */
extern long xfer_create(EndPoint &source, EndPoint &target, int32_t , XF_template *);
extern long xfer_copy(XF_template, Offset, Offset, size_t, int32_t, XF_transfer *);
...
extern long xfer_modify( XF_transfer, Offset* noff, Offset* ooff );
