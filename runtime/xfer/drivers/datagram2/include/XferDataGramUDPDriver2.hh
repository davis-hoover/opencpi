...
#ifndef Xfer_DATAGRAMUDPDriver2_H_
#define Xfer_DATAGRAMUDPDriver2_H_
...
class DGEndPoint : public EndPoint {
    ...
    std::string m_ifname;  
    struct sockaddr_in m_remote_sa;

    static bool parseRemoteEndpointInfo(
...
class UDPSocket : public Socket {
  ...
  public:
    UDPSocket(std::string& ifname, std::string& ip_addr, uint16_t portNum);
    ~UDPSocket();
...
#endif // !defined Xfer_DATAGRAMUDPDriver2_H_
