...
namespace Xfer {
  namespace OFED {
    ...
    public:
      ...
      XF::XferRequest* copy (Offset srcoff, 
			 Offset dstoff, 
			 size_t nbytes, 
      ...
      void modify(Offset new_offsets[], Offset old_offsets[] );
...
#define OFED_DEVICE_ATTRS \
	...
	XF::OFED::FactoryConfig::parse(&parent(), x);
      }
    ...
    configure(ezxml_t x)
    {
      ...
      XF::OFED::FactoryConfig::parse(NULL, x);
    }
