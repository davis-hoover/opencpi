...
void Controller2::
addTransferPreState(XF::XferRequest */*pt*/, Port &/*s_port*/, unsigned /*s_tid*/,
        ...
        if (standard_transfer) {
          try {
            ptransfer->copy (output_offsets->bufferOffset,
			     ...
			     (XF::XferRequest::Flags)(flags | XF::XferRequest::DataTransfer));
          } catch ( ... ) {
