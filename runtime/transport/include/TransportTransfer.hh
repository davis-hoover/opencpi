...
namespace Transport {
  ...
  class Transfer {
    ...
    OCPI::Xfer::XferRequest* m_xferReq[MAX_TRANSFERS];
  ...
  public:
    ...
    Buffer *consume();
    // Start the input reply transfer
    void modify(OCPI::Xfer::Offset new_off[], OCPI::Xfer::Offset old_off[]);
    ...
    void addTransfer(OCPI::Xfer::XferRequest* tx_request) {
