...
from ocpi_testing.generator import ShortGenerator
...
class TestShortGenerator(unittest.TestCase):
    def setUp(self):
        self.test_generator = ShortGenerator()
        self.seed = 987

    def assertShort(self, value):
        self.assertIsInstance(value, int)
        self.assertGreaterEqual(value, SHORT_MIN)
        self.assertLessEqual(value, SHORT_MAX)
    ...
    def test_sample_all_maximum_subcase(self):
        ...
        for value in messages[0]["data"]:
            self.assertShort(value)
            self.assertEqual(value, SHORT_MAX)
    ...
    def test_sample_all_minimum_subcase(self):
        ...
        for value in messages[0]["data"]:
            self.assertShort(value)
            self.assertEqual(value, SHORT_MIN)
