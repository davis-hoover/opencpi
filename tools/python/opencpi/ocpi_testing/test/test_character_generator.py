...
# Testing of code in character_generator.py
#
...
from ocpi_testing.generator import CharacterGenerator
...
class TestCharacterGenerator(unittest.TestCase):
    def setUp(self):
        self.test_generator = CharacterGenerator()
        self.seed = 987

    def assertCharacter(self, value):
        self.assertIsInstance(value, int)
        self.assertGreaterEqual(value, CHARACTER_MIN)
        self.assertLessEqual(value, CHARACTER_MAX)
    ...
    def test_typical_single_wave(self):
        ...
        for index, (test_value, reference_value) in enumerate(
            ...
            self.assertCharacter(test_value)
    ...
    def test_sample_all_maximum_subcase(self):
        ...
        for value in messages[0]["data"]:
            self.assertCharacter(value)
            self.assertEqual(value, CHARACTER_MAX)
    ...
    def test_sample_all_minimum_subcase(self):
        ...
        for value in messages[0]["data"]:
            self.assertCharacter(value)
            self.assertEqual(value, CHARACTER_MIN)
