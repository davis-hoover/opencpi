...
from ocpi_testing.generator import LongGenerator
...
class TestLongGenerator(unittest.TestCase):
    def setUp(self):
        self.test_generator = LongGenerator()
        self.seed = 987

    def assertLong(self, value):
        self.assertIsInstance(value, int)
        self.assertGreaterEqual(value, LONG_MIN)
        self.assertLessEqual(value, LONG_MAX)
    ...
    def test_sample_all_maximum_subcase(self):
        ...
        for value in messages[0]["data"]:
            self.assertLong(value)
            self.assertEqual(value, LONG_MAX)
    ...
    def test_sample_all_minimum_subcase(self):
        ...
        for value in messages[0]["data"]:
            self.assertLong(value)
            self.assertEqual(value, LONG_MIN)
