...
do_create_test() {
  ...
  ocpidev2 create component backpressure -d core/components
  ocpidev2 create component emulator -d core/components
  ocpidev2 create component file_read -d core/components
  ocpidev2 create component file_write -d core/components
  ocpidev2 create component metadata_stressor -d core/components
  ...
  ocpidev2 create worker backpressure.hdl -d core/components
  ocpidev2 create worker backpressure.rcc -d core/components
  ocpidev2 create worker bias.hdl -d core/components
  ocpidev2 create worker bias.rcc -d core/components
  ocpidev2 create worker bias_FGM_cc.rcc -d core/components
  ocpidev2 create worker bias_cc.rcc -d core/components
  ocpidev2 create worker bias_clock.hdl -d core/components
  ocpidev2 create worker bias_param.hdl -d core/components
  ocpidev2 create worker bias_param.rcc -d core/components
  ocpidev2 create worker bias_spcm.hdl -d core/components
  ocpidev2 create worker bias_spcm.rcc -d core/components
  ocpidev2 create worker bias_ver.hdl -d core/components
  ocpidev2 create worker bias_vhdl.hdl -d core/components
  ocpidev2 create worker bias_wide.hdl -d core/components
  ocpidev2 create worker dgrdma_config_dev.hdl -d core/components
  ocpidev2 create worker dgrdma_config_proxy.rcc -d core/components
  ocpidev2 create worker file_read.hdl -d core/components
  ocpidev2 create worker file_read.rcc -d core/components
  ocpidev2 create worker file_write.hdl -d core/components
  ocpidev2 create worker file_write.rcc -d core/components
  ocpidev2 create worker hello_world.rcc -d core/components
  ocpidev2 create worker hello_world_cc.rcc -d core/components
  ocpidev2 create worker metadata_stressor.hdl -d core/components
  ocpidev2 create worker metadata_stressor.rcc -d core/components
  ocpidev2 create worker nothing.hdl -d core/components
  ocpidev2 create worker nothing.rcc -d core/components
  ocpidev2 create worker proxy.rcc -d core/components
  ocpidev2 create worker proxy_hdl.rcc -d core/components
  ocpidev2 create worker Consumer.rcc -d core/components
  ocpidev2 create worker Loopback.rcc -d core/components
  ocpidev2 create worker Producer.rcc -d core/components
  ocpidev2 create test bias.rcc -d core/components
