...
def test_Application_create(ret):
    ...
    name = 'app1'
    project_dir = fs.abs_path + '/foo'
    apps_dir = project_dir + '/applications'
    app_dir = apps_dir + '/' + name
    try:
        Application(
            app_dir, False, None
        ).create(project_dir, False, False)
        passed = True
