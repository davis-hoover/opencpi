...
class ShowableComponent(ShowableAsset):
    ...
    def get_ocpigen_metadata(self, xml_file):
        ...
        if ocpiutil.get_dirtype(self.directory + "/../") == "library":
            xml_dirs = ocpiutil.set_vars_from_make(mk_file=ocpiutil.get_makefile(self.directory + "/../", "library"),
            ...
            xml_dirs = ocpiutil.set_vars_from_make(mk_file=ocpiutil.get_makefile(self.directory + "/../", "project"),
    ...
    def __init_package_id(self):
        ...
        if ocpiutil.get_dirtype(parent_dir) == "library":
            ret_val = ocpiutil.set_vars_from_make(mk_file=ocpiutil.get_makefile(parent_dir, "library"),
                                                  mk_arg="showpackage ShellLibraryVars=1",
                                                  verbose=True)["Package"][0]
        elif ocpiutil.get_dirtype(parent_dir) == "project":
            ret_val = ocpiutil.set_vars_from_make(mk_file=ocpiutil.get_makefile(parent_dir, "project"),
