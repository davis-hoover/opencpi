    ...
    def __init_hdltool_asset_from_dict(cls, asset_cls, name, package_id):
        ...
        if asset_cls is ocpiplat.HdlPlatform:
            ...
            return asset_cls(name=name, target=tgt_for_plat,
                             ...
                             package_id=package_id if package_id else cls.__plat_dict[name]["package_id"])
    ...
    def __parse_hdltargets_from_make(cls):
        ...
        if 'HdlAllPlatforms' in cls.__mk_dict:
            for platname in cls.__mk_dict['HdlAllPlatforms']:
                ...
                cls.__plat_dict[platname]['package_id'] = cls.__mk_dict['HdlPlatformPackageID_' + platname]
