...
OCPI_WD="../../av-test"
echo "Preparing for tests using av-test project"
VERB="clean"
ex_ocpidev ""
VERB="--no-assemblies build"
ex_ocpidev ""
VERB="run"
echo "Running Test 2"
...
OCPI_WD="temp_proj"
# temp_proj has multiple libraries
ex_ocpidev "libraries"
...
echo "Skipping Test 25"
#ex_ocpidev "targets"
echo "Skipping Test 26"
