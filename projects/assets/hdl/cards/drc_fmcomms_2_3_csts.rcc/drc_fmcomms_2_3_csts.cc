 ...
 * BASED ON THE FILE: drc_fmcomms_2_3_csts.xml
 * YOU *ARE* EXPECTED TO EDIT IT
 *
 * This file contains the implementation skeleton for the drc_fmcomms_2_3_csts worker in C++
 */

#include "drc_fmcomms_2_3_csts-worker.hh"
...
using namespace Drc_fmcomms_2_3_cstsWorkerTypes;
...
class Drc_fmcomms_2_3_cstsWorker : public OD::DrcProxyBase {
  ...
  OD::ConfigLockRequest m_requests[DRC_FMCOMMS_2_3_CSTS_MAX_CONFIGURATIONS_P];

public:
  Drc_fmcomms_2_3_cstsWorker()
    : m_doSlave(slaves),
      m_ctrlr(0, "drc_fmcomms_2_3_csts", m_configurator, m_doSlave) {
  }
  // ================================================================================================
  ...
  RCCResult prepare_config(unsigned config) {
    ...
    for (unsigned n = 0; n < nChannels; ++n) {
      ...
      stream.include_data_stream_ID(channel.rx ?
                                    DRC_FMCOMMS_2_3_CSTS_RF_PORTS_RX.data[nRx] :
                                    DRC_FMCOMMS_2_3_CSTS_RF_PORTS_TX.data[nTx]);
...
DRC_FMCOMMS_2_3_CSTS_START_INFO
// Insert any static info assignments here (memSize, memSizes, portInfo)
// e.g.: info.memSize = sizeof(MyMemoryStruct);
DRC_FMCOMMS_2_3_CSTS_END_INFO
