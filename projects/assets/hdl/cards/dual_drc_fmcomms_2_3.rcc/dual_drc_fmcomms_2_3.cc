...
///@TODO migrate to DRC.cc/DRC.hh paradigm
#include "dual_drc_fmcomms_2_3-worker.hh"
...
using namespace Dual_drc_fmcomms_2_3WorkerTypes;
...
class Dual_drc_fmcomms_2_3Worker : public OD::DrcProxyBase { 
  ...
  OD::ConfigLockRequest m_requests[DUAL_DRC_FMCOMMS_2_3_MAX_CONFIGURATIONS_P];    

public: 
  Dual_drc_fmcomms_2_3Worker()
    : m_doSlave(slaves),
      m_ctrlr(0, "dual_drc_fmcomms_2_3", m_configurator, m_doSlave) {
  }
  // ================================================================================================
  ...
  RCCResult prepare_config(unsigned config) {
    ...
    for (unsigned n = 0; n < nChannels; ++n) {
      ...
      stream.include_data_stream_ID(channel.rx ?
                                    DUAL_DRC_FMCOMMS_2_3_RF_PORTS_RX.data[nRx] :
                                    DUAL_DRC_FMCOMMS_2_3_RF_PORTS_TX.data[nTx]);
...
DUAL_DRC_FMCOMMS_2_3_START_INFO
// Insert any static info assignments here (memSize, memSizes, portInfo)
// e.g.: info.memSize = sizeof(MyMemoryStruct);
DUAL_DRC_FMCOMMS_2_3_END_INFO
