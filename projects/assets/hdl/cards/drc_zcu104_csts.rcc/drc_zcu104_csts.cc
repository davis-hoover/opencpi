 ...
 * BASED ON THE FILE: drc_zcu104.xml
 * YOU *ARE* EXPECTED TO EDIT IT
 *
 * This file contains the implementation skeleton for the drc_zcu104 worker in C++
 */

#include "drc_zcu104_csts-worker.hh"
...
using namespace Drc_zcu104_cstsWorkerTypes;
