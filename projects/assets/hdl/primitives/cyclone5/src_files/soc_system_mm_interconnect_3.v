...
module soc_system_mm_interconnect_3 (
	...
	wire          hps_0_f2h_sdram0_data_cmd_width_adapter_src_valid;                             // hps_0_f2h_sdram0_data_cmd_width_adapter:out_valid -> agent_pipeline:in_valid
	wire  [363:0] hps_0_f2h_sdram0_data_cmd_width_adapter_src_data;                              // hps_0_f2h_sdram0_data_cmd_width_adapter:out_data -> agent_pipeline:in_data
	wire          hps_0_f2h_sdram0_data_cmd_width_adapter_src_ready;                             // agent_pipeline:in_ready -> hps_0_f2h_sdram0_data_cmd_width_adapter:out_ready
	wire    [0:0] hps_0_f2h_sdram0_data_cmd_width_adapter_src_channel;                           // hps_0_f2h_sdram0_data_cmd_width_adapter:out_channel -> agent_pipeline:in_channel
	wire          hps_0_f2h_sdram0_data_cmd_width_adapter_src_startofpacket;                     // hps_0_f2h_sdram0_data_cmd_width_adapter:out_startofpacket -> agent_pipeline:in_startofpacket
	wire          hps_0_f2h_sdram0_data_cmd_width_adapter_src_endofpacket;                       // hps_0_f2h_sdram0_data_cmd_width_adapter:out_endofpacket -> agent_pipeline:in_endofpacket
	...
	wire    [0:0] agent_pipeline_source0_channel;                                                // agent_pipeline:out_channel -> hps_0_f2h_sdram0_data_agent:cp_channel
	...
	wire  [363:0] agent_pipeline_001_source0_data;                                               // agent_pipeline_001:out_data -> router_001:sink_data
	...
	wire  [111:0] cmd_demux_src0_data;                                                           // cmd_demux:src0_data -> mux_pipeline:in_data
	...
	wire  [111:0] mux_pipeline_source0_data;                                                     // mux_pipeline:out_data -> cmd_mux:sink0_data
	...
	wire  [111:0] rsp_demux_src0_data;                                                           // rsp_demux:src0_data -> mux_pipeline_001:in_data
	...
	wire  [111:0] mux_pipeline_001_source0_data;                                                 // mux_pipeline_001:out_data -> rsp_mux:sink0_data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_ready          (hps_0_f2h_sdram0_data_cmd_width_adapter_src_ready),                  //     sink0.ready
		.in_valid          (hps_0_f2h_sdram0_data_cmd_width_adapter_src_valid),                  //          .valid
		.in_startofpacket  (hps_0_f2h_sdram0_data_cmd_width_adapter_src_startofpacket),          //          .startofpacket
		.in_endofpacket    (hps_0_f2h_sdram0_data_cmd_width_adapter_src_endofpacket),            //          .endofpacket
		.in_data           (hps_0_f2h_sdram0_data_cmd_width_adapter_src_data),                   //          .data
		.in_channel        (hps_0_f2h_sdram0_data_cmd_width_adapter_src_channel),                //          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.clk               (clk_0_clk_clk),                                                           //       cr0.clk
		.reset             (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
