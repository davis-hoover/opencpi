...
add_wave_divider SUBTEST_7_DATA_SRC
add_wave {{/testbench/subtest_7/data_src}}
add_wave_divider SUBTEST_7_UUT
add_wave {{/testbench/subtest_7/uut}}
add_wave_divider SUBTEST_7_FILE_WRITER
add_wave {{/testbench/subtest_7/file_writer}}
