...
if (os.environ.get("OCPI_TEST_simulation") == "false"):
    ...
    if (correlation >= 0.7):
        print("    Output data and golden data correlation has an accepatable value")
    else:
        print("    Output data and golden data correlation has a correlation that is less than 70%")
        print("    Correlation: " + str(correlation))
        sys.exit(1)
