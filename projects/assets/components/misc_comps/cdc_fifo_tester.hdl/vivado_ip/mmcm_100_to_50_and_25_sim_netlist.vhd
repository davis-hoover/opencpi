...
architecture STRUCTURE of mmcm_100_to_50_and_25_mmcm_100_to_50_and_25_clk_wiz is
  ...
  signal clk_out1_mmcm_100_to_50_and_25_en_clk : STD_LOGIC;
  signal clk_out2_mmcm_100_to_50_and_25 : STD_LOGIC;
  signal clk_out2_mmcm_100_to_50_and_25_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_mmcm_100_to_50_and_25,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out1_mmcm_100_to_50_and_25_en_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_out2_mmcm_100_to_50_and_25,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out2,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out2_mmcm_100_to_50_and_25_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_mmcm_100_to_50_and_25_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_mmcm_100_to_50_and_25_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
