...
\fi
\def\importpath{}
\input{\importpath snippets/CIC_Dec_Header}
%----------------------------------------------------------------------------------------
...
\input{\importpath snippets/CIC_RCC_Implementation}
...
\begin{landscape}
	...
	\input{\importpath snippets/cic_dec.rcc_properties}
	...
	\input{\importpath snippets/cic_dec.rcc_interfaces}
