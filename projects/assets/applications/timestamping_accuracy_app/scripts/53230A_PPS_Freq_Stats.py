...
if len(sys.argv) != 2:
    print("Invalid arguments:  usage is: 53230A_PPS_Freq_Stats.py <ip-address-of-53230-counter>")
    sys.exit(1)
...
for a in [10,100]:
  ...
  print("Min                : "+str(freq_cnt.ask("CALC:AVER:MIN?"))+" Hz")
  print("Max                : "+str(freq_cnt.ask("CALC:AVER:MAX?"))+" Hz")
  print("Average            : "+str(freq_cnt.ask("CALC:AVER:AVER?"))+" Hz")
  print("Standard Deviation : "+str(freq_cnt.ask("CALC:AVER:SDEV?"))+" Hz")
