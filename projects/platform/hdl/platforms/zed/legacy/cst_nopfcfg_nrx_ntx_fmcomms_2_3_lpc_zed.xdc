...
create_generated_clock -name FMC_LA08_P -source [get_pins {ftop/FMC_ad9361_data_sub_i/worker/mode7.dac_clock_forward/C}] -divide_by 1 -invert [get_ports {FMC_LA08_P}]
...
set_false_path -from [get_ports FMC_LA01_CC_P] -rise_to [get_pins ftop/FMC_ad9361_adc_sub_i/worker/supported_so_far.rx_frame_p_ddr/D]
...
set_clock_groups -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks -of_objects [get_pins ftop/FMC_ad9361_dac_sub_i/worker/data_mode_lvds.BUFR_inst/O]]
