.. platform_ad9361_spi documentation
...
.. _platform_ad9361_spi:


AD9361 SPI (``platform_ad9361_spi``)
====================================
Defines properties for implementing an SPI state machine
for communication with the AD9361 integrated circuit.
``platform_ad9361_spi`` is an asset in the ``ocpi.platform.devices`` component library.
Implementations include the
:ref:`platform_ad9361_spi-HDL-worker` (``platform_ad9361_spi.hdl``).
...
.. figure:: ad9361_spi_block_diagram.png
...
Limitations
-----------
Limitations of ``platform_ad9361_spi`` are:
