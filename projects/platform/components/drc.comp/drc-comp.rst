...
The mathematical representation of the component function is given in :eq:`drc-equation`.
...
A block diagram representation of the component function is given in :numref:`drc-diagram`.
...
Interface
---------
.. literalinclude:: ../specs/drc-spec.xml
   :language: xml
...
Implementations
---------------
.. ocpi_documentation_implementations:: ../drc.hdl ../drc.rcc
