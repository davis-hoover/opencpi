...
The mathematical representation of the component function is given in :eq:`emulator-equation`.

.. math::
   :label: emulator-equation

   y[n] = \alpha * x[n]


In :eq:`emulator-equation`:
...
A block diagram representation of the component function is given in :numref:`emulator-diagram`.
...
Interface
---------
.. literalinclude:: ../specs/emulator-spec.xml
   :language: xml
...
Implementations
---------------
.. ocpi_documentation_implementations:: ../emulator.hdl ../emulator.rcc
