...
PKGS="cmake python39 swig3 swig3-python swig-python scons coreutils gsed py39-numpy libtool autoconf automake py39-jinja2 gmake enchant"
# no sphinxcontrib_spelling
PKGS+=" py39-sphinx py39-sphinx_rtd_theme"
