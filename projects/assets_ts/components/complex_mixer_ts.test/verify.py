...
if(enable == 'true'): # => NORMAL MODE
    ...
    if np.array_equal(din_samples_array, dout_samples_array):
        print ('      PASS - Bypass Mode: Input and output file match')
    else:
        print ('Fail - Bypass Mode: Input and output file do not match')
        # print(len(din_samples_array))
        # print(len(dout_samples_array))
        # print(np.array_repr(din_samples_array))
        # print(np.array_repr(dout_samples_array))
        sys.exit(1)
