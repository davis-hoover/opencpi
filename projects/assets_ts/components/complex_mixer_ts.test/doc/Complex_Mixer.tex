...
\begin{tabular}{|c|M{13.5cm}|}
	...
	\hline
\end{tabular}
\input{Complex_Mixer_Functionality}
\section*{Worker Implementation Details}
\input{Complex_Mixer_HDL_Implementation}
\input{Complex_Mixer_Theory}
...
\begin{itemize}
	\item projects/assets\_ts/components/complex\_mixer.hdl/complex\_mixer.vhd
        \input{Complex_Mixer_Primitive_Dependencies}
\end{itemize}
