# [v2.4.7](https://gitlab.com/opencpi/opencpi/-/compare/v2.4.6...v2.4.7) (2024-01-04)

Changes/additions since [OpenCPI Release v2.4.6](https://gitlab.com/opencpi/opencpi/-/releases/v2.4.6)

### Features
- **app**: updated the fsk_dig_radio_ctrl image. (!1057)(b6fcacfb)
- **comp**: support include and xi:include. (!995)(ebd35042)
- **comp**: replace xi:include in property files with include. (!995)(ebd35042)
- **comp,tests**: add ability to compare top N bits of fractional time in ocpi_testing. (!1144)(45d4d09e)
- **devops**: enable autoscaling for CI/CD pipelines. (!1115)(2b0e5ab6)
- **devops**: enable parallel building of workers in CI/CD pipelines. (!1115)(2b0e5ab6)
- **devops**: allow for skipping of certain CI/CD pipeline jobs if relevant changes are not made to the repo. (!1120)(5c7c286a)
- **devops**: make non-MR CI/CD pipelines start automatically after being launched. (!1124)(2da5d1c8)
- **devops**: remove sudo from centos7 docker images. (!1125)(048f09e4)
- **devops**: update ubuntu dockerfiles. (!1126)(8f2019c3)
- **devops**: update rocky8 dockerfile. (!1128)(6b9a432d)
- **devops**: allow projects using downstream-ci.yml to pass the `CI_OCPI_PLATFORMS` and `CI_OCPI_PROJECTS` variables when set in the project settings. (!1130)(baad9f06)
- **devops**: re-implement CI/CD pipeline HWIL. (!1137)(92efb17b)
- **devops**: enabling CI/CD pipelines to deploy full docker images to public registry. (!1141)(8c4d366d)
...
- **devops**: add x310 and x3u platforms to CI config to enable them to run properly in pipelines. (!1022)(243d0bbd)
- **devops**: update docs to support building docs in forked projects. (!1091)(80eba8b2)
- **devops,tools**: add `rocky8` RCC development platform support. (!874)(cd558c26)
- **devops,tools**: add `ubuntu22_04` RCC development platform support. (!885)(4f8b666c)
...
- **doc**: add node graph to Tutorial 1. (!1039)(123ce17f)
- **doc**: add node graph to tutorial 2. (!1040)(d85c577b)
- **doc**: move picoevb and zed RST files and images to be co-located with their assets. (!1041)(95806072)
- **doc**: update picoevb and zed GSG to refer to information in User Guide and Installation Guide. (!1041)(95806072)
- **doc**: add missing hyphen to `ocpidev` command for #3647. (!1142)(11896d00)
- **doc**: update tutorial docs for new code, and grammar issue #3646. (!1142)(11896d00)
- **doc,tools**: remove `--rcc-platform` from `ocpidev run` man page, for #3662. (!1142)(11896d00)
- **doc,tools**: add `ocpi_documentation_include` directive to ocpidoc. (!882)(877eb994)
- **doc,tools**: add RST templates for OSP-related documentation. (!1008)(82b22c6a)
...
- **osp**: add zed_ether platform as an HDL DG-RDMA reference OSP. (!947)(7de0ace9)
- **runtime**: add ability to dump data when ocpirun receives CTL+C. (!1114)(6a5039d1)
...
- **runtime**: enable MacOS Ventura (macos13_0) as an RCC platform and for remote containers. (!1017)(6dbc4bc5)
- **runtime,tests,tools**: add optimized framework build capability. (!1077)(ba66363d)
...
- **tests,tools**: add end_of_files function to ocpi_testing. (!1112)(d56f975b)
...
- **tools**: allow device parameters in card/platform XML to service as defaults, and be specified as fixed or overridable. (!1002)(78b274ce)
- **tools**: device parameters in card XML can be tagged as applying to specific platforms. (!1002)(78b274ce)
- **tools**: device-to-platform signal mappings can index the platform signal. (!1018)(40a2b265)
- **tools**: the part number and even part family for an HDL platform can be defined in the platform's XML, and not need a core repo change. (!1018)(40a2b265)
- **tools**: constraint file references in XML can include parameters which are tcl variable settings. (!1018)(40a2b265)
- **tools**: updated the drc's to add the pincontrol value. (!1057)(b6fcacfb)
- **tools**: add `mint21_1` RCC development platform support. (!1069)(19315540)
- **tools,tools**: add python38 and required associated modules to `rocky8-packages.sh`. (!1025)(87639584)
- **protocols,tests**: add SCPI parser prerequisite to test project. (!1029)(0ce3bd8e)
- **runtime**: add Log namespace to make ACI logging functions consistent with RCC logging. (!1003)(5223c6d6)
- **tools**: throws error message when duplicate attributes are used in same xml element tag. (!1009)(3d41b60a)
- **tools**: add OpenCPI linter tool. (!1076)(51e21a8a)

### Bug Fixes
- **comp**: fix `data_src.vhd` and `data_src_cswm.vhd` slice directions. (!1056)(725bc603)
- **comp**: fix `adapt_width` output opcode reordering. (!1074)(771cd638)
- **comp,doc**: modify `peak_detector` tutorial to fix #3648 and #3649. (!1142)(11896d00)
- **devops**: change commit ref env var used in doc jobs to avoid character conversion. (!1106)(c73380fb)
- **devops**: fix deploy job invalid image reference format. (!1116)(b936ec65)
- **devops**: fix deploy pages job not cloning repo. (!1116)(b936ec65)
- **devops**: make post-merge pipelines not require a manual trigger. (!1116)(b936ec65)
- **devops**: prevent CI/CD pipelines from installing OSP projects on host platforms. (!1118)(1da2a534)
- **devops**: fix invalid syntax in yaml preventing osp and comp project pipelines from running. (!1129)(90c424d2)
- **devops**: update dind version in CI/CD pipeline deploy jobs. (!1131)(4a6246da)
- **devops**: fix CI/CD pipeline test jobs using wrong image tag. (!1133)(3c12be67)
- **devops**: fix MR failures for external projects. (!1138)(51eac05d)
...
- **devops**: fix ci_report.py not including all failed jobs in reports for a given CI/CD pipeline. (!1027)(aeafe032)
- **devops**: reimplement `hdl-assemblies.mk` assembly validation logic in `ci_generate_pipeline.py`. (!1058)(ef76f252)
- **devops,tools**: fix `util.mk:OcpiGetKernelDir()` for container environments. (!885)(4f8b666c)
- **doc**: fix air-gapped installation typo. (!1088)(ac254ca4)
...
- **runtime**: external port methods getInputBuffer and getOutputBuffer now work in the Python ACI. (!1018)(40a2b265)
- **runtime,tests,tools**: fixes for optimized builds of RCC platforms. (!1077)(ba66363d)
...
- **tests,tools**: fix kill of `printToConsole()` in `testrun.sh`. (!1043)(e60b78b5)
- **tools**: change lzma prerequisite source. (!1113)(2d4902a7)
- **tools**: add various missing `.gitignore`s. (!1142)(11896d00)
- **tools**: add `.coverage` to pytests clean command. (!1142)(11896d00)
- **tools**: ocpigen: change opcode_pos to natural in hdl code generation. (!816)(85740873)
...
- **tools**: remove gmp comments inside gpsd prereq install script. (!1013)(4ed6ae02)
- **tools**: enable ComponentLibraries attributes in proxy worker, assembly, and assemblies XML files. (!1017)(6dbc4bc5)
- **tools**: fix `--hdl-rcc-platform` option to work again in ocpidev. (!1017)(6dbc4bc5)
- **tools**: fixed ocpidev show components to show both components in specs/ and .comp. (!1030)(89ee65ac)
- **tools**: update ocpi_documentation_implementations.py to recognize worker docs named *-hdl.rst and *-rcc.rst. (!1035)(9d2a079f)
- **tools**: fix version comparison in `install-vivado.sh` script. (!1037)(611ceedb)
- **tools**: ocpigen: fix `hdl-card.cc` loop exit for "no match found" case. (!1042)(7175dfb6)
- **tools**: fix `TOPTS` assignment in `ocpiadmin.sh`. (!1049)(6c259375)
- **tools**: ocpidev: modify ComponentsCollection::show() for JSON output. (!1050)(5b21cb2a)
- **tools**: disable `show+verbose` code blocks in `ocpidev/assets/project.py`. (!1059)(997a95c1)
- **tools**: ocpiadmin: fix variable name error in `getvars()` function. (!1077)(ba66363d)
- **tools**: fix container to allow signals to have an empty platform (not used). (!1082)(d3081fff)
- **tools,tools**: fix `ocpigen` parser so `modelsim` platform will install. (!1062)(97f4d27d)
- **comp**: prepare can handle and enter the error state. (!1007)(368d21d1)
- **comp**: a stop on a inactive results in an error. (!1007)(368d21d1)
- **tools**: fix broken delete libraries. (!991)(4c91e000)

### Miscellaneous
- **comp**: remove unused 'enable' property. (!942)(9eea6bd1)
- **comp**: fix `spec=` attributes in XML files. (!1059)(997a95c1)
- **comp**: modernize legacy `drc-spec.xml` and `emulator-spec.xml` OCS files. (!1059)(997a95c1)
- **devops**: temporarily disable zcu102 and picoevb HWIL jobs in pipelines. (!1022)(243d0bbd)
- **devops,doc**: update `opencpi.gitlab.io` home page. (!1028)(98041e32)
- **doc**: add updated man page, asset doc system instructions to writer guide. (!1016)(e304c740)
- **doc**: update docs for 2.5.x platform support. (!1016)(e304c740)
- **doc**: update util_comps-library.rst file to recognize component RST docs named *-comp.rst. (!1038)(bf711640)
- **doc,tools**: remove obsolete getting started guide template. (!1008)(82b22c6a)
- **doc,tools**: update RST doc index templates to search for latest asset naming schemes, include warning about subsidiary filenames. (!1008)(82b22c6a)
- **doc,tools**: change section heading titles and "Function" text in component RST template. (!1008)(82b22c6a)
- **doc,tools**: document new `ocpiadmin` tool installer functionality. (!1046)(890998d3)
- **tools**: update tool python files to use python3 shebang. (!1026)(267c9d84)
- **tools**: fix `ocpigen` code comments made obsolete by MR !1018 changes. (!1042)(7175dfb6)
- **tools**: delete obsolete and undocumented `makeProject.sh` script. (!1059)(997a95c1)
- **tools**: minor `ocpidev` refactoring to resolve `**kwargs` vs. `kwargs` vs. `args` usage. (!1059)(997a95c1)
- **tools,tools**: remove ubuntu16_04 RCC development platform support. (!1020)(88a87109)
- **doc**: fix incorrect statements in the rcc and application dev guides and update tutorials 1-5 and 10. (!1068)(768a50aa)
