# [v2.5.0-alpha.1](https://gitlab.com/opencpi/opencpi/-/compare/v2.4.3...v2.5.0-alpha.1) (2022-10-26)

Changes/additions since [OpenCPI Release v2.4.3](https://gitlab.com/opencpi/opencpi/-/releases/v2.4.3)

### Enhancements
- **devops**: add Ubuntu18.04 support to CI pipelines. (!842)(2fc0efd5)
- **devops**: don't run/build unit tests in CI pipelines for platforms when there is not a worker of the appropriate model available. (!859)(1d5b13b7)
- **devops**: allow multiple devices of same platform in HWIL CI pipelines. (!862)(1332223f)
- **devops**: enable zcu102, picozed, microzed platforms in HWIL CI pipelines. (!862)(1332223f)
- **devops**: add source_sink application to CI/CD pipelines. (!867)(0eae0e52)
- **devops**: add testbias app to CI pipelines. (!875)(13b4d819)
- **devops**: prevent attempts to build inactive platforms in CI pipelines. (!875)(13b4d819)
- **devops**: let runner dictate device to connect to in HWIL CI pipelines. (!875)(13b4d819)
- **devops**: make pipeline ignore warnings from ocpidev. (!880)(ad9c8552)
- **devops**: add FSK app to CI pipelines. (!893)(feccd726)
- **devops**: add failed job report to CI pipelines. (!894)(c0026da7)
- **devops**: auto push develop and release docker images to gitlab container registry. (!954)(da29f8d2)
- **devops**: add zcu111 to pipeline. (!964)(7b6738bf)
- **devops**: fix section that pushes to gitlab registry to use predefined ci variables. (!985)(46482d35)
- **devops,tools,tools**: add `rocky8` RCC development platform support. (!874)(cd558c26)
- **devops,tools,tools**: add `ubuntu22_04` RCC development platform support. (!885)(4f8b666c)
- **doc,tools**: add `ocpi_documentation_include` directive to ocpidoc. (!882)(877eb994)
- **hdl base**: add DG-RDMA Primitive Library. (!947)(7de0ace9)
- **hdl base**: add (optional) fairer arbitration scheme to SDP. (!947)(7de0ace9)
- **hdl base**: add DG-RDMA configuration device worker and proxy. (!947)(7de0ace9)
- **hdl base**: add Ethernet MAC dependency. (!947)(7de0ace9)
- **osp**: add Riviera-Pro support. (!906)(5e074965)
- **osp**: adds zed_ether platform as an HDL DG-RDMA reference OSP. (!947)(7de0ace9)
- **runtime**: adjust error message and fix memory issue. (!872)(9fc49553)
- **runtime**: add worker property settings to system.xml, either app or artifact. (!877)(10c53c07)
- **runtime**: add statically defined devices in system.xml, with options to include static devices or not. (!877)(10c53c07)
- **runtime**: add various fixes to make DGRDMA work properly. (!877)(10c53c07)
- **runtime**: introduce loadtime workers which have artifact load/unload lifecycle, not app lifecycle. (!877)(10c53c07)
- **runtime**: add static discovery method and support for JTAG programming for Ethernet devices. (!947)(7de0ace9)
- **runtime**: improvements to datagram transfer driver. (!947)(7de0ace9)
- **runtime**: add new datagram2 transfer driver. (!947)(7de0ace9)
- **tests**: fix and expand successful testing in the iqstream_max_calc test app including testing on hardware. (!922)(7a5f218a)
- **tests**: print to console after a certain time while running tests. (!943)(1cdf7755)
- **tests,tools**: ocpigen: rework build config validation into a method of the Case struct. (!886)(5ad1095a)
- **tests,tools**: ocpigen: simplify and correct logic in validateBuildConfigs. (!890)(3439f89a)
- **tools**: ocpidev create/build/clean/delete applies to doc for all asset types. (!792)(48375dfd)
- **tools**: ocpidev: revamp/augment the class structures for asset types to remove the legacy bash and ocpidev run/show scripts. (!838)(1c664e3c)
- **tools**: ocpidoc: have all the appropriate ocpidev verbs and nouns call ocpidoc as needed. (!838)(1c664e3c)
- **tools**: support MacOS 12.2. (!838)(1c664e3c)
- **tools**: add ping utility to package installation script for ubuntu18_04. (!842)(2fc0efd5)
- **tools**: add an optional flag --export for ocpidev build. (!864)(5d986aeb)
- **tools**: output message when platforms excluded by OnlyPlatforms or ExcludePlatforms variables. (!869)(6cb4815c)
- **tools**: add `util.mk:OcpiIsContainer()`. (!885)(4f8b666c)
- **tools**: upgrade `gpsd` prerequisite from version 3.18 to version 3.23.1. (!885)(4f8b666c)
- **tools**: create batch mode installation script for Xilinx tools. (!889)(6f4f8f92)
- **tools**: make `install-xilinx-tools.sh` non-interactive. (!892)(9e58479e)
- **tools**: ocpiadmin: integrate Xilinx Vivado tool installer functionality. (!909)(2465b983)
- **tools**: add wireshark dissectors for DG-RDMA protocol. (!947)(7de0ace9)
- **tools**: skeleton file generated upon creation of hdl platform worker. (!982)(63c6bd09)
- **tools**: make device parameters in hdl platforms and cards act as defaults for that platform/card. (!986)(3da54321)

### Bug Fixes
- **devops**: pull correct docker images in OSP CI pipelines. (!859)(1d5b13b7)
- **devops**: use "-b" flag in "ocpiremote start" command in CI pipelines. (!859)(1d5b13b7)
- **devops**: patch `config.yml` for `zcu102` build. (!865)(1c34c150)
- **devops**: fix job report failing when a job timed out. (!900)(a0b2ba57)
- **devops**: use predefined ci variable to point to gitlab container registry. (!989)(d381290d)
- **devops,tools**: fix `util.mk:OcpiGetKernelDir()` for container environments. (!885)(4f8b666c)
- **doc**: remove conflicting `--worker` option from ocpidev man pages that was conflicting with `--workers-as-needed`. (!838)(1c664e3c)
- **runtime**: refactor `runtime/base` storage allocation logic. (!887)(0aa598f3)
- **runtime**: make requests for default parameter values in apps and slave assemblies get default parameter values. (!986)(3da54321)
- **runtime**: fix non-uniform exception being thrown using incorrect method and as non-string type within runtime code. (!994)(c11cdcaf)
- **tests**: disable some build configurations from building. (!959)(a096ee73)
- **tests,tools**: fix termination of background process in `testrun.sh`. (!996)(6b9c809d)
- **tools**: change opcode_pos to natural in hdl code generation. (!816)(85740873)
- **tools**: make ocpidev both do better error checking on names, and allow more "legacy" names. (!876)(ed40a180)
- **tools**: fix issue with deleting components. (!876)(ed40a180)
- **tools**: fix issue with ocpidev showing nested libraries. (!876)(ed40a180)
- **tools**: ocpidev: fix project name handling to allow periods. (!895)(e4fadc45)
- **tools**: ocpidev: fix handling of `hdl-primitives` plural noun to allow for non-existent directories. (!895)(e4fadc45)
- **tools**: fix ocpidev delete project to only unregister if it deletes. (!898)(abce881e)
- **tools**: fix ocpidev inferring noun from hdl directories. (!899)(d1cea641)
- **tools**: make it so you can build primitive library and cores from the primitives directory. (!901)(205a9939)
- **tools**: fix ocpidev build hdl assemblies command to be able to be run from a project directory. (!903)(a9f35e4e)
- **tools**: fix newly created hdl platforms using the wrong Makefile when using the `ocpidev build` command. (!904)(ed1fe16a)
- **tools**: fix ocpidev creating incorrect paths to a project's hdl platforms directory. (!904)(ed1fe16a)
- **tools**: fix the ocpidev create hdl primitive command, that was creating a copy of the primitive in the wrong directory. (!905)(0b6dcb9e)
- **tools**: fix not being able to run .xml applications. (!907)(67fcef4c)
- **tools**: ocpiadmin: fix broken `--url=URL` option parsing. (!909)(2465b983)
- **tools**: display protocol name correctly when executing 'ocpidev show component'. (!910)(a66a2985)
- **tools**: fix "--only-platform" and "--exclude-platform" options for "ocpidev run". (!911)(63c23a2a)
- **tools**: fix "ocpidev run" "--phase" option not working. (!913)(0e90d73c)
- **tools**: give proper ocpidev error message when invalid option and no noun provided. (!915)(80cfbaf4)
- **tools**: prevent "ocpidev show" from printing inaccurate warnings when "OCPI_PROJECT_PATH" env var is set. (!918)(3c7d167c)
- **tools**: restore ability to use "--view" option with "ocpidev run". (!927)(f47de6e8)
- **tools**: worker skeleton files not generated for different authoring models. this fix generates both .vhd and .cc files. (!951)(4bca6909)
- **tools**: make requests for default parameter values in hdl assemblies and containers get default parameter values. (!986)(3da54321)
- **tools**: fix `OsEther.cc` compile error on `ubuntu22_04` platform. (!997)(7d177ecc)

### Miscellaneous
- **comp**: remove unused 'enable' property. (!942)(9eea6bd1)
...
### Enhancements
- **doc**: add Avnet and Xilinx platform information to shared systems tables file. (!917)(acdec5ea)
- **doc**: add warning about view option and multiple test cases to ocpidev-test man page and Component Development Guide. (!948)(ca3f3dac)
- **doc**: add OpenCPI Documentation Writer Guide source file (FODT format). (!958)(daf611a0)
- **doc**: update doc/reference/README to refer to new writer guide. (!958)(daf611a0)
- **doc**: update doc/reference/diagrams.txt to refer to new writer guide for latest procedures. (!958)(daf611a0)
- **doc**: add new chapter on Linux kernel driver module to OpenCPI User Guide. (!962)(d3c82f53)
- **doc**: revise chapter on PCI Express installation to be generic and describe loading driver. (!962)(d3c82f53)
- **doc**: add reference to Linux kernel driver chapter in OpenCPI User Guide. (!962)(d3c82f53)
- **doc**: add description of --no-kernel option to ocpiadmin man page. (!962)(d3c82f53)
- **doc,tools**: modify ocpidoc to use both project *and* common dictionaries. (!923)(1b1a26a9)
- **doc,tools**: enhancement to enable comments in ocpidoc dictionary. (!940)(35b0ad57)
- **doc,tools**: add `make declare` preprocessing of COMPs and OSPs to `build-pages.py`. (!978)(ca6a8b6a)
- **osp**: add parameters to DRC spec to allow optional inclusion of slave DSP workers. (!984)(e05ebd0a)
- **runtime**: add static discovery method and support for JTAG programming for Ethernet devices. (!973)(ea02d2a5)
- **tools**: copy macos12_4 to macos12_5 to enable macos12_5 with no changes from macos12_4. (!944)(f3a7624d)
- **tools**: add controls for more and less (than previous default) SDP pipelining in container code generation. (!955)(3e19f598)
- **doc**: update tutorial 4. (!961)(06548fb7)
- **doc**: updates to tutorials 6-10. (!963)(bf3c56aa)
- **doc**: update tutorial 5. (!965)(6bbda885)
- **doc**: tutorial 1: update GUI figures and add additional prerequisite for default editor configuration. (!967)(e6f117dc)
- **doc**: tutorial 1: replace deprecated "done" keyword with "finished". (!967)(e6f117dc)
- **doc**: tutorial 2: remove default editor instructions as they have been moved to OpenCPI GUI guide. (!968)(1e7d4a8e)
- **doc**: tutorial 2: replace deprecated "done" keyword with "finished". (!968)(1e7d4a8e)
- **doc**: update tutorial 3. (!969)(84f4b83a)
- **hdl base,runtime,tools**: add DG-RDMA interconnect support. (!957)(63ce844f)
- **runtime**: add static discovery method and support for JTAG programming for Ethernet devices. (!980)(24d8010e)

### Bug Fixes
- **doc**: add instructions on using server mode to Installation Guide. (!917)(acdec5ea)
- **doc**: fix formatting errors and examples in ocpiremote man page. (!917)(acdec5ea)
- **doc**: add information to ocpidriver man page about working with secure boot. (!962)(d3c82f53)
- **doc,tools**: fix issue with ocpidoc not finding proxy worker spec files. (!923)(1b1a26a9)
- **hdl base**: add additional pipelining to DG-RDMA infrastructure. (!973)(ea02d2a5)
- **hdl base**: sdp_pipeline replace use of fifo_1xn with fifo_2xn. (!973)(ea02d2a5)
- **hdl base**: fix fifo_2xn. (!973)(ea02d2a5)
- **hdl base**: fix incorrect combinatorial path when not arbitrating in sdp_node. (!973)(ea02d2a5)
- **runtime**: fix crash when proxies that are also slaves are started by their proxy. (!937)(960c8f78)
- **runtime**: reject all workers with parameter values that do not match defaults when the default is requested. (!944)(f3a7624d)
- **runtime**: fix clock domain crossings in the time server. (!973)(ea02d2a5)
- **runtime**: fix datagram2-ether transfer driver. (!990)(f192a8d2)
- **runtime**: fix project exports to allow export platform that uses cpp_vhd. (!990)(f192a8d2)
- **tests**: make iqstream tests work on modelsim. (!932)(7175b285)
- **tests,tools**: add `zlib1g-dev` package to ubuntu package lists. (!928)(bfc7e743)
- **tests,tools**: modify centos7 packages script for pip3-installed packages (Python modules). (!935)(e4e57fde)
- **tools**: fix byte width definition when data width is greater than granule width. (!896)(28e0d348)
- **tools**: `ocpidev run` now throws error when unable to find platform specified by `--only-platform`. (!914)(1a3b2ee0)
- **tools**: build-pages.py: handle projects that do not have tags. (!916)(1825cc3c)
- **tools**: fix timegate_csts worker. (!925)(364f3c30)
- **tools**: fix verify.py in tutorial project's peak_detector.test to properly validate min/max peak. (!926)(623fa7b8)
- **tools**: swap non-ascii encoded characters with ascii equivalents. (!938)(141e0b23)
- **tools**: fix minor xml issues with opencpi component specifications. (!938)(141e0b23)
- **tools**: fix typo in longlong ocpi protocol defines. (!938)(141e0b23)
- **tools**: fix minor typo in OpenCPI's `README.md` file. (!941)(41bd2a43)
- **tools**: properly record in artifact XML whether a parameter value is indeed the default value. (!944)(f3a7624d)
- **tools**: do not create a build configuration for default values when the build file has configurations, none of which are the default. (!944)(f3a7624d)
- **tools**: fix header file names for C++ files to be the same as runtime C++ header files, namely hh. (!955)(3e19f598)
- **tools**: fix failures in container connections with devices in platform conigurations. (!966)(c13fc78e)
- **tools**: prevent ocpidoc error when port type not defined. (!973)(ea02d2a5)
- **tools**: fix `build-pages.py` to use `ocpidev build` when needed. (!977)(14eb1a9b)
- **tools**: fix missing parameter values and default-value indicators in artifact XML. (!983)(b81f411c)
- **tools**: build-opencpi.sh: add `assets_ts` to `Projects` for minimal framework installs. (!987)(28c1a752)
- **hdl base**: add additional pipelining to DG-RDMA infrastructure. (!980)(24d8010e)
- **hdl base**: sdp_pipeline replace use of fifo_1xn with fifo_2xn. (!980)(24d8010e)
- **hdl base**: fix fifo_2xn. (!980)(24d8010e)
- **hdl base**: fix incorrect combinatorial path when not arbitrating in sdp_node. (!980)(24d8010e)
- **runtime**: fix clock domain crossings in the time server. (!980)(24d8010e)
- **tools**: prevent ocpidoc error when port type not defined. (!980)(24d8010e)
- **tools**: fix ocpidoc build issue. (!980)(24d8010e)
- **tests**: exclude fir_complex_sse_ts.test fir_complex_sse.test fir_real_sse.test from picoevb due to lack of dsp resources (!934)(95480541)
- **runtime**: fix datagram2-ether transfer driver (!990)(829b1849)
- **runtime**: fix project exports to allow export platform that uses cpp_vhd (!990)(829b1849)

### Miscellaneous
- **devops**: update copyright scripts. (!960)(fc8f2817)
- **devops,tools**: disable processing of releases older than v1.7 by `build-pages.py --all`. (!919)(8d444fb7)
- **tools**: add `avnet` and `xilinx` to list of OSPs for doc generation. (!916)(1825cc3c)
- **tools**: ocpidev: mitigate stricter parameter value checking. (!987)(28c1a752)
- **devops**: backport MR !955 changes into `release-2.4.3` branch. (!974)(1b130c1a)
- **tools**: backport v2.4-required fixes from MR !885. (!933)(799a9ac8)
...
### Enhancements
- **comp,tests**: remove makefiles from the .test and .hdl workers used in tutorial 6. (!772)(b4539c8f)
- **comp,tests**: remove makefiles from agc_complex.hdl and agc_complex.test. (!775)(08e2df44)
- **devops**: overhaul the CI pipeline scripts for host platforms. (!728)(f0fe4603)
- **devops**: containerize CI pipeline for host platforms (centos7 and ubuntu18_04). (!728)(f0fe4603)
- **devops**: prevent commits from launching pipelines unless on the develop branch. (!728)(f0fe4603)
- **devops**: add hardware in the loop capabilities to pipeline overhaul. (!769)(ca09cc42)
- **devops**: integrate osp projects in pipeline overhaul and containerization effort. (!776)(8cbed9ef)
- **devops**: add comp projects to pipeline overhaul/containerization effort. (!803)(3620bac2)
- **devops**: resolve resource contention between CI pipelne jobs that install for Xilinx platforms. (!810)(333e5c0e)
- **devops,tests**: overhaul and containerize CI/CD pipelines for cross platforms. (!755)(a5cb117c)
- **doc**: add links to YouTube videos, to the opencpi.gitlab.io website. (!722)(a5a11eba)
- **doc**: update tutorial 1-4 to use new GUI. (!761)(a1196d27)
- **doc**: add ocpitest(1) man page. (!773)(3ab1d9f6)
- **doc**: add CLI commands and new GUI screenshots to tutorial 8. (!777)(de0f7571)
- **doc**: update tutorial 7 introductory sections and move primitives section. (!778)(5d1ea175)
- **doc**: update tutorial 7 new project, component library sections. (!778)(5d1ea175)
- **doc**: update tutorial 7 new worker sections. (!778)(5d1ea175)
- **doc**: update tutorial 7 unit test and brief ocpiview sections. (!778)(5d1ea175)
- **doc**: add gui and cli section marks to tutorial 7. (!778)(5d1ea175)
- **doc**: update the 6th tutorial by adding new screenshots using the new opencpi gui, adding more detailed instructions and a new section on how to navigate the simulator used in the tutorials. (!782)(cc63f4b2)
- **doc**: update tutorial 8. (!786)(2061830b)
- **doc**: add cli and gui sections and update based on more Lisa comments. (!791)(14db225e)
- **doc**: clarify component specification terminology in tutorial 1 overview. (!797)(40c7a8ad)
- **doc**: add briefing on Application Control Interface (ACI). (!800)(392f7cd2)
- **doc**: add briefing on OpenCPI debugging tools and techniques. (!800)(392f7cd2)
- **doc**: update OpenCPI Installation Guide to describe latest GUI installation instructions. (!801)(e23fa800)
- **doc**: update ocpigui(1) man page to describe latest usage information for GUI startup command. (!801)(e23fa800)
- **doc**: add instructions to perform an air-gapped installation. (!806)(5385f82c)
- **doc**: add updated and new *.fodt files to doc/tutorials/. (!807)(61ff8908)
- **doc**: remove obsolete "in progress" tutorials from doc/tutorials/hold. (!807)(61ff8908)
- **doc,tools**: add directive to ocpidoc to list an asset's tested platforms. (!748)(fcd634d1)
- **hdl base**: add example usage for raw2axi interface. (!726)(58d6e63b)
- **hdl base**: remove duplicate complex_mixer in tutorial project. (!799)(c27b5ac3)
- **runtime**: change all files under os/ now have names that match our conventions, and nearly no warnings. (!727)(2a4312bc)
- **runtime**: move metadata management files into their own library and make file names compliant. (!742)(081897ab)
- **runtime**: reorganize/rename files under runtime/util to be compliant and consistent. (!756)(bfbe939f)
- **runtime**: update file, namespace naming and reduce warnings in dataplane C++ code. (!762)(daa9280b)
- **runtime,tools**: cleanup runtime filenaming and namespacing and warnings. (!767)(21ac5973)
- **tests**: replace done with finished in all test.xml files. (!729)(19ecea91)
- **tools**: replace bash with python for ocpidev build test command. (!705)(795d4e03)
- **tools**: add xilinx virtual cable driver as a development host prerequisite. (!734)(a9917d0f)
- **tools**: update picoevb programming scripts to use Xilinx virtual cable driver prerequisite. (!740)(83f5d754)
- **tools**: set pci_bus_master when enabling pci device. (!743)(8ac9fb60)
- **tools**: add litefury and nitefury to pci_device_id enum. (!743)(8ac9fb60)
- **tools**: add macos12_0 (a.k.a.Monterey) support. (!767)(21ac5973)

### Bug Fixes
- **app**: replace && with &amp in all xml files. (!813)(b087536b)
- **comp**: fix naming collision between tutorial 9 worker and `counter` primitive. (!774)(e3fa4c3a)
- **comp**: fix tutorial `prims` library build failure. (!780)(03b17777)
- **devops**: fix various problems with CI pipeline overhaul and containerization. (!810)(333e5c0e)
- **doc**: replace references to Make files, *.mk files, makefile variables with references to XML files and attributes. (!735)(207f7126)
- **doc**: replace references to AV GUI in text and figures with OpenCPI GUI. (!735)(207f7126)
- **doc**: replace references to older systems & platforms with references to latest. (!735)(207f7126)
- **doc**: replace references to "run" phase with "execute" phase in component test suite descriptions. (!735)(207f7126)
- **doc**: add --optimize option to description and examples, fix typos in ocpiadmin(1) man page. (!773)(3ab1d9f6)
- **doc**: fix typos and remove "AV" from first figure in Installation Guide. (!773)(3ab1d9f6)
- **doc**: fix time_demux.test. (!783)(5c1ff89c)
- **doc**: add briefing sources saved with LibreOffice 5 on centos7 for correct PDF generation. (!800)(392f7cd2)
- **doc**: update Tutorials 3 and 4 to provide "copy file from tutorial project" instructions. (!804)(c3ebd7e7)
- **doc**: update Tutorial 3 to improve section on creating example worker code. (!804)(c3ebd7e7)
- **doc**: change ocpi.tutorial project agc_complex data sheet to display properties and ports. (!807)(61ff8908)
- **doc,tools**: fix `ocpidoc` to wrap long property values and support commented out xi include elements. (!737)(9db83fe9)
- **tests**: fix and enable gpi.test case00.00 case01.00 case02.00. (!758)(73211e6e)
- **tests**: fix the --view flag. (!802)(228d7b72)
- **tools**: add the `--workers-as-needed` flag to the `ocpidev build test` function. (!715)(27de3f44)
- **tools**: test asset default moves from project to components library. (!716)(22d1a646)
- **tools**: fix xsim detection for newer xilinx tool versions 2021.1+. (!723)(293eecc5)
- **tools**: fix ocpigen to not segfault on writable properties for instances in slave assemblies. (!727)(2a4312bc)
- **tools**: generate assemblies for valid subcases. (!757)(aad7a5a1)
- **tools**: fix broken metadata generation. (!770)(d777cb67)
- **tools**: fix genProjMetaData.py removing '.xml' extension for xml apps. (!789)(d6b2c392)
- **tools**: ocpiview: exec `bash` instead of `sh`. (!793)(bd6f49a8)
- **tools**: fix broken framework and platform installs due to inappropriately unsetting all `OCPI_*` variables. (!812)(8cd4e85a)

### Miscellaneous
- **comp**: convert tutorial 9 components to use `makeless` build environment. (!779)(8eb6b1fb)
- **comp**: add complex_mixer.hdl back to tutorial project. (!805)(e997a4f6)
- **doc**: add videos to website. (!745)(566c52f2)
- **doc**: tutorial 9: add OpenCPI GUI instructions and update screenshots. (!793)(bd6f49a8)
- **doc**: updates the documentation to copy the simulator version of tutorial 6. (!796)(11dc8787)
- **doc**: add pluto instructions to separate tutorial 7 doc. (!808)(f147199f)
- **doc**: re-contextualize tutorial 8 around complex_mixer_tutorial. (!811)(72e940c9)
- **doc**: update the hardware version of tutorial 8. (!811)(72e940c9)
- **doc**: update 8th tutorial to use complex_mixer in the assets project. (!814)(b64c20ea)
- **doc**: update gui variable in 8HW tutorial. (!815)(772a53de)
- **doc**: fix tutorial 4's release info. (!815)(772a53de)
- **doc**: fix tutorial 7hw's view flag and ToC. (!815)(772a53de)
- **doc**: initial overhaul of Tutorial 9. (!774)(e3fa4c3a)
- **doc**: add GUI section selection logic to tutorial 9 source document. (!779)(8eb6b1fb)
- **doc**: update Tutorial 9 GUI sections. (!781)(4af0fb75)
- **doc**: add updated tutorial 5. (!794)(dc404ddc)
- **doc,tools**: add tutorial project documentation to `opencpi.gitlab.io` web site. (!784)(e8ada53e)
