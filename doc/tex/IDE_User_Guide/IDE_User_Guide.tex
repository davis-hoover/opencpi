...
\newpage
\section{Install The IDE}
\newcommand{\cmd}[1]{\subitem \textbf{cmd:} \code{#1}}
The OpenCPI IDE is installed using the instructions in the \href{https://opencpi.gitlab.io/releases/latest/docs/OpenCPI\_Installation\_Guide.pdf}{OpenCPI Installation Guide}, in the section entitled Installing AV, the Optional Eclipse-based GUI.
