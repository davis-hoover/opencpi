...
\begin{center}
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{|c|X|l|}
			...
			\hline
			v2.3.0 & Updates for 2.3.0 release & 08/2021 \\
			\hline
		\end{tabularx}
	\end{table}
\end{center}
...
The ``\code{PicoEVB}'' HDL platform is new in this release.
...
\label{sec:23_analog}
This release provides initial OpenCPI support of \code{ADRV9361-Z7035} attached to \code{ADRV1CRR-BOB}.
